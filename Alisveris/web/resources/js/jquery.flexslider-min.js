    ...
    d.flexslider = function(i, k) {
        ...
        a.flexAnimate = function(b, g, n, i, k) {
            ...
            if (!a.animating && (a.canAdvance(b, k) || n) && a.is(":visible")) {
                ...
                if (r)
                    p ? (a.slides.eq(a.currentSlide).css({opacity: 0,
        ...
        a.setup = function(b) {
            if (r)
                a.slides.css({width: "100%",
                    "float": "left", marginRight: "-100%", position: "relative"}), "init" === b && (p ? a.slides.css({opacity: 0, display: "block", webkitTransition: "opacity " + c.animationSpeed / 1E3 + "s ease", zIndex: 1}).eq(a.currentSlide).css({opacity: 1, zIndex: 2}) : a.slides.eq(a.currentSlide).fadeIn(c.animationSpeed, c.easing)), c.smoothHeight && f.smoothHeight();
            else {
                var g, n;
